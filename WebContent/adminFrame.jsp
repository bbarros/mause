...
<f:view>
	<div id="header">
	  <div class="subContainer">
	    ...
	    <div id="logout">
	    	<h:form>
		    	<h:commandLink action="#{adminFrameBean.logout}" >
	...
	<div id="navigation">
	  	<a4j:form id="tabsForm">
			<ul>
			    <li>
			    	<a4j:commandLink action="#{adminFrameBean.showUsuario}" reRender="primaryPanel">
	...
	<div id="container">
	  <div id="primaryContent">
	  	<rich:panel id="primaryPanel">
			<a4j:include viewId="/adminInicial.jsp" rendered="#{adminFrameBean.usuarioIsVisible}"/>
	  	</rich:panel>
	  </div> <!-- /primaryContent -->
	  <br class="clear" />
	</div> <!-- container -->
